...
Once set, the coil seperation was not varied, but it was bounded between 1--2\unit{\inch} during the design process, with a target value of \qty{1.5}{\inch}.
...
Outside of minimizing loop area, size was not a design constraing.
...
As the resonent tank was designed for a \qty{50}{\ohm} source and load, an additional 2 port VNA measurement was taken to capture the resonant tank for comparison to the simulation.
...
\begin{appendices}
    ...
    \begin{figure}[H]
        ...
        \caption{Rectifier, STPS360AF varient (used)}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[page=2,width=0.78\linewidth]{figure/sch/Rectifier-SCH.pdf}
        \caption{Rectifier, RB058LAM100TFTR varient (not used)}
    \end{figure}
    \begin{figure}[H]
        \centering
    ...
    \begin{figure}[H]
        ...
        \caption{
            ...
            (a)\; Rectifier, STPS360AF varient (used)\quad
            (b)\; Rectifier, RB058LAM100TFTR varient (not used in final configuration)
        }
    \end{figure}
    \begin{table}[H]
        \centering
