...
The converter operates from a $\mathbf{\qty{25}{\volt}}$ DC input and delivers $\mathbf{\qty{35}{\watt}}$ output power with high efficiency.
...
\end{figure*}
This final project presents the design and implementation of a \qty{6.78}{\mega\hertz} push--pull $\Phi_2$ wireless power transfer converter operating from a \qty{25}{\volt} dc input and delivering \qty{35}{\watt} to the load.
...
\begin{figure*}[]
    \begin{minipage}{\linewidth}
        ...
        \caption{\centering
            ...
            (a)\; $R_\mathrm{load} = 50 \Omega$\quad
            (b)\; $R_\mathrm{load} = 61.685 \Omega$\quad
            (c)\; $R_\mathrm{load} = 75 \Omega$
        }
