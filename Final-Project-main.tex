...
After the front-end push--pull $\Phi_2$ converter was constructed, it was first tested under a no-load condition. Two complementary 0--5~V square-wave gate-drive signals with a 180\unit{\degree}$^\circ$ phase shift were generated using a \verb|Keysight 33510B| waveform generator. 
