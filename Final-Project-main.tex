...
\begin{table}[!ht]
    ...
    \begin{tabular}{cccc}
        ...
        \midrule
        Input Voltage $V_\textrm{DC}$   & \qty{25}{\volt} & \qty{18}{\volt} & \qty{28}{\volt}\\
        Switching Frequency$f_\textrm{s}$ 
            \footnote{Originally, \qty{6}{\mega\hertz}-\qty{7}{\mega\hertz} was tested, but this was reduced after some component failures. However, this may not have been the cause of the failures as another failure did ultimately occur}$f_\textrm{s}$
            & \qty{6.78}{\mega\hertz} & \qty{6.7}{\mega\hertz} & \qty{6.9}{\mega\hertz}\\
        Output Power $P_\textrm{o}$   & --- & --- & ---\\
        Coil Separation $d$ & \qty{35.39}{\milli\meter}\footnote{Plus X additional, see drawing and recalculate} & --- & ---  \\
        \bottomrule
    \end{tabular}
