...
Minor fluctuations in the measured data are attributed to measurement accuracy limitations.\hfil\textcolor{white}{\tiny\cref{fig:spectrum:VD}}
%\begin{verbbox}
...
\begin{figure}[!hb]
    ...
    %    \caption{\verbBox}
    \caption{}
%    \caption{Spectrum of $P_{D_{AB}}$, with \texttt{N2791A} differential probe at 10X attenuation, \qty{1}{\mega\ohm} series resistor, and \qty{20}{\dB} LNA. Assumed attenuation of \qty{72.833}{\dB}, figure uncorrected}
\end{figure}
%\cref{x1}
%\\
%\begin{verbbox}
