...
These results should mainly be used to see the harmonics present at each point measured in the circuit. The multiresonant point spectrum can be seen in \ref{fig:mrspec}.
