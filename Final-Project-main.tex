...
\begin{table*}%[!h]
	...
	\includestandalone[width=0.95\columnwidth]{table/results/sims/femm/coils_v1_fixed}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\columnwidth]{figure/sch/awr-resonant-tank-sch-crop.pdf}
