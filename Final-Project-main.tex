...
These results should mainly be used to see the harmonics present at each point measured in the circuit.
...
%TODO Reference figures and explain them
\begin{figure}[!b]
    \centering
...
\begin{appendices}
    ...
    \begin{table}[H]
        \centering
%  todo insert      \input{table/bom/BOM-Rectifier.tex}
