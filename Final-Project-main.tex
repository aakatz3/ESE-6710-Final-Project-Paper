...
\begin{tabular}{cccc}
    \csvreader[head to column names, table head=\toprule\bfseries Component Designator & \bfseries Value & \bfseries Manufacturer & \bfseries Part Number\\ \midrule,table foot=\bottomrule]
    {table/bom/BOM-ProbeEmulator.csv}{}%
    {\Designator & \Value & \Manufacturer & \ManufacturerPartNumber}
    \centering
    \caption{Bill of Materials for the capacitance Emulator}
