...
For instructional purposes, a lab manual has been provided
outlining the modeling, characterization, and construction of a wireless Class-D resonant converter. 
This report presents the extracted device parameters, LTSpice simulations, and experimental measurements of the converter.
\end{abstract}
...
\begin{figure}[!htb]
    ...
    \includegraphics[
        ...
        clip                               
    ]{Script/plottings/lab2schematic.eps}
...
\begin{figure}[h]
	\centering
    \subfloat[Experimental]{\includegraphics[width=0.48\columnwidth]{Script/plottings/resonantbodemeas.eps}\label{fig:resonantbodemeas}}
	\hfil
	\subfloat[Simulation]{\includegraphics[width=0.48\columnwidth]{Script/plottings/resonantbodespice.eps}\label{fig:resonantbodespice}}
...
\begin{figure}
    \centering
    \includegraphics[angle=270,origin=c,width=0.3\linewidth]{FLIR/FLIR1000024}
    \hfil
    \includegraphics[angle=270,origin=c,width=0.3\linewidth]{FLIR/FLIR1000029}
    \hfil
    \includegraphics[angle=270,origin=c,width=0.3\linewidth]{FLIR/FLIR1000023}
...
\begin{figure*}[!t]
    \centering
    \subfloat[]{\includegraphics[width=0.32\linewidth]{Script/plottings/IpPP_vs_fs_scope.eps}\label{fig:ip-fs}}
    \hfil
    \subfloat[]{\includegraphics[width=0.32\linewidth]{Script/plottings/Vo_vs_fs_meter.eps}\label{fig:vo-fs}}
    \hfil
    \subfloat[]{\includegraphics[width=0.32\linewidth]{Script/plottings/VoVi_vs_fs_meter.eps}\label{fig:ratio-fs}}
    \vspace{6pt} 
    \subfloat[]{\includegraphics[width=0.32\linewidth]{Script/plottings/Pout_vs_fs_meter.eps}\label{fig:pout-fs}}
    \hfil
    \subfloat[]{\includegraphics[width=0.32\linewidth]{Script/plottings/eta_vs_fs_meter.eps}\label{fig:eta-fs}}
    \caption{
        \centering
