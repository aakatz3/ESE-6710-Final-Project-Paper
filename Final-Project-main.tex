...
\begin{appendices}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\linewidth]{figure/pcb_layout/Rectifier-PCB.pdf}
        \caption{PCB Layout of the rectifier}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfloat[]{\includegraphics[height=144pt]{figure/photo/board/RX.png}}
        \hfil
        \subfloat[]{\includegraphics[height=144pt]{figure/photo/board/TX.png}}
        \caption{
            \centering
            Assembled coil interface:\quad
            (a) RX
