...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\linewidth]{figure/photo/single_coil}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\linewidth]{figure/photo/coil_pair}
...
For results obtained from the spectrum analyzer, all signals were passed through an attenuation, a 10X passive scope probe (with \qty{1}{\mega\ohm} series resistor), a \qty{20}{\dB} LNA, a \texttt{Keysight N2791A} differential probe, or some combination of the former.
...
\begin{figure}[!ht]
    \begin{minipage}{\columnwidth}
        ...
        \caption{Spectrum of $P_{MR}$, with 10X passive scope probe, \qty{1}{\mega\ohm} series resistor, and 20dB LNA. Apparent attenuation of \qty{72.833}{\dB}, figure uncorrected.}
    \end{minipage}
\end{figure}
\begin{figure}[!ht]
    \centering
    ...
    \caption{Spectrum of $P_{D_{AB}}$, with \texttt{N2791A} differential probe at 10X attenuation, \qty{1}{\mega\ohm} series resistor, and 20dB LNA. Assumed attenuation of \qty{72.833}{\dB}, figure uncorrected.}.
\end{figure}
