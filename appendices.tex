...
\begin{appendices}
    ...
    \begin{figure}[H]
        \centering
        \subfloat[]{\includegraphics[height=216pt]{figure/photo/board/RX.png}\label{fig:board:RX}}
        \hfil
        \subfloat[]{\includegraphics[height=216pt]{figure/photo/board/TX.png}\label{fig:board:TX}}
        \caption{
            \centering
    ...
    A GitHub repository with all of the code, data, full resolution images, and any relevant instructions can be found at:
