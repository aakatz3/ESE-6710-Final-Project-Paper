...
\AtBeginDocument{% Create vna verbbox
...
% Custom units
\DeclareSIUnit{\shortInch}{\"}
\DeclareSIUnit{\shortFoot}{\'}
...
\ExplSyntaxOn
\NewDocumentCommand \EnsureTitleCase { m }
{
    \MakeTitlecase [ words=all ] { \text_lowercase:n {#1} }
}
\ExplSyntaxOff
