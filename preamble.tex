...
\ifluatex
	...
	\setmathfont{StixTwoMath}[Scale=1]
	%  \AtBeginDocument{\setlength{\baselineskip}{8pt}}
	%  \setmonofont[Scale=MatchAveragecase]{Courier}
	%  \setmonofont[Scale=MatchAveragecase]{Courier New}
	%  \setmonofont[Scale=MatchAveragecase]{Cascadia Mono}
	%  \setmonofont[Scale=0.89]{Cascadia Mono}
	%   \usepackage{plex-mono}
	% Matches STIX/Times better
	\setmonofont[scale=MatchAverageCase, ScaleAgain=0.9]{IBMPlexMono}
	%  \setsansfont[scale=MatchAveragecase]{Helvetica}
	%  \setsansfont[scale=MatchAveragecase]{Arial}
	\setsansfont{Roboto}[scale=MatchAveragecase]
\else
...
\lstdefinelanguage{spice}{
	...
	moredelim=[l][\color{spiceDotCommand}]{.meas},
	moredelim=[l][\color{spiceDotCommand}]{.op},
	moredelim=[l][\color{spiceDotCommand}]{.tra},
	moredelim=[l][\color{spiceDotCommand}]{.par},
	moredelim=[l][\color{spiceDotCommand}]{.lib},
	moredelim=[l][\color{spiceDotCommand}]{.end},
	moredelim=[l][\color{spiceDotCommand}]{.OPT},
}
...
% longtable does not work in multicolumn
...
% Proper positioning of double column floats; incompatible with stfloats
...
%\usepackage{svg} - Disabled due to font problems
\usepackage{enumitem}
